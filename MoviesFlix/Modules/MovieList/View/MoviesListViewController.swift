...
extension MoviesListViewController:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout
{
   ...
   func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = movieCollection.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! MoviesCell
        if(shouldShowSearchResults)
        {
            ...
            let data = try? Data(contentsOf: url!)
            cell.imageView.image = UIImage(data: data!)
            cell.title.text = arrayList?.results[indexPath.row].title
            cell.overview.text = arrayList?.results[indexPath.row].overview
        }
        return cell
    }
...
extension MoviesListViewController:UISearchBarDelegate, UISearchDisplayDelegate{
...
class MoviesCell:UICollectionViewCell, UIGestureRecognizerDelegate{
...
extension UIColor{
 static let themeColor = UIColor(red: 244.0/255.0, green: 179.0/255.0, blue: 68.0/255.0, alpha: 1.0)
}
